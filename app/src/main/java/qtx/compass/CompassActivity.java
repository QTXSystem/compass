...
/**
 * Created by qtxdev on 7/9/2016.
 */
public class CompassActivity  extends qtx.compass.SensorsActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        text = (TextView) findViewById(R.id.txtDegrees);
    ...
    public void onSensorChanged(SensorEvent evt) {
        ...
        updateText(qtx.compass.GlobalData.getBearing());
    }
