...
import qtx.compass.LowPassFilter;
...
/**
 * Created by qtxdev on 6/21/2016.
 */
public class SensorsActivity extends Activity implements SensorEventListener, LocationListener {
    ...
    public void onResume() {
        ...
        Sensor countSensor = sensorMgr.getDefaultSensor(Sensor.TYPE_MAGNETIC_FIELD);
        if (countSensor != null)
             sensorMgr.registerListener(
                   this,
            ...
            Toast.makeText(this, "The device doesn't have sensor TYPE_MAGNETIC_FIELD.",
